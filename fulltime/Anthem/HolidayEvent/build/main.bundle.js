...
function submitToAPI(e) {
  ...
  var data = (_data = {
    ...
    brokerage: brokerage,
    email: email
  }, _defineProperty(_data, 'brokerage', brokerage), _defineProperty(_data, 'eventLocation', eventLocation), _defineProperty(_data, 'eventDateAndTime', eventDateAndTime), _data);
